<footer class="relative w-full mx-auto flex items-center justify-center mt-20 flex-col bg-[var(--bg-white)] pt-24">
    <div class="w-full absolute top-0 translate-y-[-50%] left-0 right-0  z-0">
        <svg class="w-full h-full" id="Group_1264" data-name="Group 1264" xmlns="http://www.w3.org/2000/svg"
            ...
            <path class="w-[100%]" id="Path_1784" data-name="Path 1784"
            ...
            <path class="w-[100%]" id="Path_1785" data-name="Path 1785"
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="flex mt-7 w-full">
                    <div class="flex items-start justify-between gap-8 w-full flex-wrap fade-up">
                        <div class="flex flex-col items-start justify-start gap-2 w-full sm:w-[200px] ">
                            <h6 class="text-[15px] text-[var(--yello-primary)] font-bold w-full text-center sm:text-right">
                                الوصول السريع:</h6>
                            <ul
                                class="flex flex-col gap-1 w-full items-center justify-center sm:items-start sm:justify-start">
                                <li><a class="text-[var(--dark-primary)] font-semibold text-[10px] md:text-[13px]"
                                        href="#">الرئيسية</a>
                                </li>
                                <li><a class="text-[var(--dark-primary)] font-semibold text-[10px] md:text-[13px]"
                                        href="#">عن ماسترز</a>
                        ...
                        <div class="flex flex-col items-start justify-start gap-2 w-full sm:w-[200px] ">
                            ...
                            <ul
                                ...
                                <li><a class="text-[var(--dark-primary)] font-semibold text-[10px] md:text-[13px]" href="#">
                                        العروض</a>
                                </li>
                                <li><a class="text-[var(--dark-primary)] font-semibold text-[10px] md:text-[13px]"
                                        href="#">الفروع</a></li>
                ...
                <div class="w-full mt-10 ">
                    ...
                    <div class="flex flex-col ">
                        <h6 class="text-[var(--yello-primary)] font-bold text-[15px] fade-up">إشترك لتصلك أحدث عروض وخدمات
                            ماسترز
                            الطبية:</h6>
