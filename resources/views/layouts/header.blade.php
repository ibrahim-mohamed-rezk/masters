<header class="header  w-full flex items-center justify-start flex-col relative "
                ...
                <div class="top-bar__container w-full flex items-center justify-between py-5">
                    <div class="social">
                        <ul class="social-list flex items-center justify-center gap-3">
                            <li class="social-icon border rounded-full flex items-center justify-center cursor-pointer">
                    ...
                    <a href="#" class="news flex items-center justify-center gap-3">
                        <span class="news__ribbon font-bold text-white text-wrap">متاح الآن</span>
                        <span class="news__text font-bold ">عروض الصيف</span>
                    </a>
    ...
    <div class="w-full absolute bottom-0 translate-y-[50%] left-0 right-0  z-0">
        <svg class="w-full" id='Group_1264' data-name='Group 1264' xmlns='http://www.w3.org/2000/svg' width='1920' height='214'
            viewBox='0 0 1920 214'>
