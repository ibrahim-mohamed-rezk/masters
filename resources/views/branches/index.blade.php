    ...
    <div class="container">
        ...
        <div class="flex flex-col items-start gap-2 w-full">
            <h2 class="fade-up text-[20px] md:text-[31px] font-bold text-[var(--dark-primary)] ">
                ماسترز حولك <span class="text-[var(--yello-primary)]">أينما كنت </span>
            </h2>
            <p class="fade-up text-[var(--text-gray)] text-[12px] md:text-[15px] font-bold">
                تعرف على عنواين فروع ماسترز، وتوجه للفرع الأقرب لك.
            </p>
        </div>

        <div class="flex items-start justify-between flex-col lg:flex-row w-full mt-10 gap-5">
            <div class="flex items-start w-full lg:w-[25%] px-2 fade-up">
                <div class="w-full flex flex-col items-center justify-center gap-5">

                    <div class="w-full p-3 bg-[var(--bg-white)] rounded-2xl flex items-center justify-center">
                        <form class="w-full flex items-center justify-center bg-white rounded-3xl px-2 fade-up">
                    ...
                    @for ($i = 0; $i < 9; $i++) <div
                        ...
                        <div class="">
                            ...
                            <div class="rounded-2xl overflow-hidden">
                                <img src="{{ asset('assets/images/branches/branch-1.jpg') }}" alt="doctor">
                            </div>

                            <div class="flex flex-col items-center justify-center mt-4 gap-1 px-2">
                                <h3 class=" text-[12px] md:text-[15px] font-bold text-[var(--dark-primary)] text-center"> الفرعي -
                                    سيد الشهداء
                                       الجلدية و التجميل و الليزر ، الطبي
                                </h3>
                                <span class="block text-[13px] font-bold text-[var(--yello-primary)]">ماسترز
                                    الأسنان</span>
                                <span class="text-[13px] font-bold text-[var(--text-gray)] text-center">جدة – حي
                                    البساتين - نهاية شارع الامير سلطان شمالا - مقابل مدارس العرب
                                    جدة</span>
                            </div>
